...
import {
    Landmark, CheckCircle2, XCircle, FileSearch, ArrowRight,
    X, ImageIcon, CheckCircle, AlertCircle, RotateCcw,
    ThumbsDown, Info, FileText, Search, Loader2, AlertTriangle,
    Banknote, BadgeAlert, RefreshCw
} from 'lucide-react';
        ...
        <div className="space-y-6 pb-20 font-sans">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 font-medium text-sm">Validasi setoran penagih terhadap mutasi Bank Jabar BJB.</p>
                </div>
